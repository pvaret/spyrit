...
class ANSI_COLORS:
    ...
    # Tentatively try Solarized colors.

    # Dark colors:

    black = SOLARIZED.base03
    red = SOLARIZED.dark_red
    green = SOLARIZED.dark_green
    yellow = SOLARIZED.dark_yellow
    blue = SOLARIZED.dark_blue
    magenta = SOLARIZED.dark_magenta
    cyan = SOLARIZED.dark_cyan
    lightgray = SOLARIZED.base0

    # Light colors:

    darkgray = SOLARIZED.base01
    red_h = SOLARIZED.red
    green_h = SOLARIZED.green
    yellow_h = SOLARIZED.yellow
    blue_h = SOLARIZED.blue
    magenta_h = SOLARIZED.magenta
    cyan_h = SOLARIZED.cyan
    white = SOLARIZED.base1
